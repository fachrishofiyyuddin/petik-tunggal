...
<body>
    <div class="container">
        <h2>Munggunakan Perintah <i>Addslashes</i></h2>
        <hr>
...
if (isset($_POST['BtnSimpan'])) {
    ...
    $nim = $_POST['nim'];
    $perintah = "addslashes()";
    $cara_kerja = "Fungsi ini mengubah karakter-karakter khusus menjadi bentuk yang lebih aman untuk disimpan dalam string, tetapi ini hanya melibatkan penambahan backslash dan tidak benar-benar mempersiapkan string untuk query SQL";
        ...
        echo '<script>
                swal({
                    ...
                    button: "OK"
                     ...
                     window.location.href = "' . $url . 'addslashes.php' . '";
                });
            </script>';
    } else {
        echo '<script>
